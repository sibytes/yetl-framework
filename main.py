...
from yetl.metasource.metasource2 import FileMetasource
templateLoader = FileMetasource(searchpath="./project")
templateEnv = jinja2.Environment(loader=templateLoader)
pprint(templateEnv.list_templates(filter_func=FileMetasource.template_filter("Dataset", "TableSchema")))
